...
# De code van de setup wordt één keer, aan het begin gerund, en de code in de
# stmt wordt het aantal ingevoerde herhalingen gerunt. Zo kun je bijvoorbeeld
# ook testen of het handig is om iets vooraf 1x te definieren of het binnen een
# functie te zetten!

# We gebruiken hetzelfde voorbeeld als hierboven: vind alle even getallen

# Het statement staat geheel tussen ''' ''', en bevat alleen het aanroepen van de functie

# We doen niks met de output (return), staan die niet op in een variabele.
stmt1 = '''
methode1(n)
'''
...
#%% Dit is dezelfe code als hierboven gebruikt, om te testen of die werkt
import numpy as np
