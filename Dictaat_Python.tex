...
\bigbreak
{\bf Truc:} Als je \pythoninline{ax.set_xlim(None, None)} invoert, gebeurt er niks. Dus roep je de functie aan zonder een waarde voor \pythoninline{xmin, xmax} op te geven en je gebruikt in je functie gewoon \pythoninline{ax_set.xlim(xmin,xmax)}, gebeurt er niets, terwilj als je wel waardes meegeeft, dat netjes ingevuld wordt. Hetzelfde geldt voor \pythoninline{label, set_xlabel, set_ylabel, set_ylim}.
