...
% Docent: Steven Boonstoppel, 2021-2022
...
import numpy as np
\end{python}
Op deze manier wordt \pythoninline{numpy} ge\"importeerd onder de gebruikelijke afkorting \pythoninline{np}. Vanaf dit punt wordt naar \pythoninline{numpy} verwezen als \pythoninline{np}. Om functies uit een module te gebruiken wordt de afkorting van de module als prefix (voorvoegsel) gebruikt, gevolgd door een punt, en dan het commando(= de naam van de functie) uit de module. Bijvoorbeeld: \pythoninline{np.mean(X) # berekent het gemiddelde van X}.%\bigbreak
